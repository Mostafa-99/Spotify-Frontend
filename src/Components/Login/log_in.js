...
class log_in extends Component {
    ...
    return (
        <div id="mysignup">
            ...
            <button id="fbsignup2" class="myspotifybutton" ><i className="fab fa-facebook fa-lg white-text mr-md-2 mr-3 fa-1x"> </i>CONTINUE WITH FACEBOOK</button>
            <button id="applesignup" class="myspotifybutton"><i className="fab fa-apple fa-lg white-text mr-md-2 mr-3 fa-1x"> </i>CONTINUE WITH APPLE</button>
            <h6>or</h6>
            <hr/>
            ...
            <button id="login" class="myspotifybutton" type="submit ">LOG IN</button>
            <br/>
            <a href="# " target="_blank ">Forgot your password?</a>
            <hr/><br/>
            <h6>Don't have an account?</h6>
            <button class="myspotifybutton" id="signupnow" type="submit">SIGN UP FOR SPOTIFY</button>
            <hr/>
