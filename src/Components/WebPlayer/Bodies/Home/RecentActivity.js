...
render(){
	...
	<div class="notification_wrap">
		...
		<div class="notification_icon" onClick={()=> this.toggledropdown()}>
        ...
        {this.state.recents.map( recents => (
			<div class="notify_item">
				<div class="notify_img">
					<img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" alt="profile_pic"></img>
				</div>
				<div class="notify_info">
					<p>{recents.description}</p>
                    <span class="notify_time">{recents.time}</span>
				</div>
			</div>
        ))}
