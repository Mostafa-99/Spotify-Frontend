...
class Home extends Component {
  ...
  constructor() {
    ...
    this.state = {
      ...
      genres: [],
      /** object that stores the id of the selected genres
       * @memberof Home
       * @type {{id: string}}
       */
  ...
  componentDidMount() {
    ...
    //browse catagories
    axios
      .get(this.context.baseURL + "/browse/categories", {
        headers: {
    ...
    //artists
    axios
      .get(this.context.baseURL + "/artists", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token"),
        },
        /*params: {
    ...
    //recently played
    axios
      .get(this.context.baseURL + "/me/player/recentlyPlayed", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token"),
        },
        params: {
    ...
    //popular albums
    axios
      .get(this.context.baseURL + "/albums/top", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token"),
        },
        params: {
    ...
    //popular playlists
    axios
      .get(this.context.baseURL + "/playlists/top", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token"),
        },
        params: {
    ...
    .then((res) => {
      if (res.status === 200) {
        this.setState({
          genres: res.data.data.albums.map((genre) => ({
            id: genre._id,
            title: genre.name,
            imageUrl: genre.image,
            artist: genre.artists[0].name,
            genre: genre.genre,
          })),
        });
            ...
            {this.state.pageLoaded ? 
              <div id="webplayer-home">
                <div className="made-for-you-section">
                  <h2 className="section-title made-for-you">
                    Most Recent Playlists
                  </h2>
                          ...
                          <div className="card" id={playList.id}>
                            ...
                            <div className="card-body">
                              ...
                              <div id={playList.id}>
                                <button
                                  id={playList.id}
                                  className="btn btn-primary play-btn active-play"
                                  onClick={() =>
                                    this.togglePlayPause(playList.id)
                                  }
                                >
                ...
                <div className="popular-playlists-section">
                  <h2 className="section-title popular-playlists">
                    Popular Playlists
                  </h2>
                  <div className="card-group">
                ...
                <div className="workout-playlists-section">
                  <h2 className="section-title workout-playlists">
                    Most recent Albums
                  </h2>
                  <div className="card-group">
                            ...
                            <div className="card-body">
                              ...
                              <div id={album.id}>
                                <button
                                  id={album.id}
                                  className="btn btn-primary play-btn active-play"
                                  onClick={() => this.togglePlayPause(album.id)}
                                >
                                  <i className="fa fa-play"></i>
                                </button>
                                <button
                ...
                <div className="popular-artists-section">
                  <h2 className="section-title popular-artists">
                    Popular Artists
                  </h2>
                  <div className="card-group">
                            ...
                            <div className="card-body">
                              ...
                              <div id={artist.id}>
                                <button
                                  className="btn btn-primary play-btn active-play"
                                  onClick={() =>
                                    this.togglePlayPause(artist.id)
                                  }
                                >
                                  <i className="fa fa-play"></i>
                                </button>
                      ...
                      <div>
                        ...
                        >
                          <div className="card" id={album.id}>
                            ...
                            ></img>
                            <div className="card-body">
                              <h5 className="card-title">{album.genre}</h5>
                              <div id={album.id}>
                                <button
                                  id={album.id}
                                  className="btn btn-primary play-btn active-play"
