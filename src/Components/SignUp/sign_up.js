    ...
    return (
        ...
        <hr></hr>
           <form id="SignUpForm" class="text-center p-5" action="#!">
            ...
            <h5>Date of Birth </h5>
            <div class="row">
                <input type="number" id="SignUpFormDay " name="signup_form[dob_day] " required="required " max="31" maxlength="2" min="1" pattern="[0-9]*" placeholder="Day" class="dob " data-msg-required="Please enter a valid day of the month"></input>
